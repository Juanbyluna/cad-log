...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  ...
  <main class="px-3">
    <h1>Seja Bem-Vind@</h1>
    <p class="lead">Esta página é o rusultado final de uma atividade de programação realizada na Escola 
    Social Irmão Acácio (Marista).Esta página foi programada com HTML.5 e PHP.</p>
    <p class="lead">
